...
import ImprintDialog from '@/components/footer/imprint';
import PrivacyDialog from '@/components/footer/privacy';
import TermsDialog from '@/components/footer/terms';
import { Button } from '@/components/ui/button';

type LegalType = 'privacy' | 'imprint' | 'terms';
            ...
            <footer className="border-t border-white/10 py-6">
                <div className="container mx-auto px-4">
                    <div className="grid items-center gap-4 md:grid-cols-3">
                        <div className="min-w-0 text-center text-sm text-white/60 md:text-left">
