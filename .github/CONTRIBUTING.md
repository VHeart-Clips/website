...
> [!IMPORTANT]
> This documentation concerns the development of the VHeart platform. If you have any content/moderation concerns, **please contact staff on the [Discord server](https://go.vheart.net/discord) instead!**

Thank you for considering to contribute to the development of VHeart, here's some information in the hows-and-whys of it.

## AI Contributions

Contributions must be written by humans.

Pull requests that appear to contain AI-generated code will be closed without review at our discretion.

Repeated or deliberate violations may result in a permanent ban from contributing.

## Licensing and Ownership

By submitting a PR you confirm the code is your own work, you have full permission to use it, and you agree your contribution will be licensed under the [GNU Affero General Public License v3.0](LICENSE).

## Reporting Bugs

If you want to report bugs, please do the following:

* Before creating an issue in this repository, please make sure the issue isn't already reported. Check [the list of issues](https://github.com/VHeart-Clips/website/issues) for that!
...
* [Create your issue!](https://github.com/VHeart-Clips/website/issues/new)
...
For Security related issues please see our [Security Policy](https://github.com/VHeart-Clips/website/security/policy)

## Submitting Pull Requests

You want to help with code contributions? That's awesome!

If no issue exists for the bug you want to fix or feature you want to implement, please [create one](https://github.com/VHeart-Clips/website/issues/new) ahead of time.
...
* [Fork this repository.](https://github.com/VHeart-Clips/website/fork)
* [Setup a local development environment.](/docs/development/setup.md)
* Create a branch for your topic.
  * This allows you to keep the `master` branch up to date with upstream over time, if you plan to contribute multiple things.
...
* [Create a Pull Request](https://github.com/VHeart-Clips/website/compare) with your created branch.
