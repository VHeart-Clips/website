...
return [
    ...
    'categories' => [
        ...
        'external-services' => [
            ...
            'description' => 'We use third-party services such as Twitch to enhance the functionality of the site, however, these third-party services may set their own cookies if enabled.',
        ],
    ],
