...
return [
    ...
    'categories' => [
        ...
        'external-services' => [
            ...
            'description' => 'Wir verwenden externe dienstleister wie twitch welche um die funktionalität der seite zu verbessern, diese externen dienste können jedoch wenn aktiviert eigene cookies setzen.',
        ],
    ],
