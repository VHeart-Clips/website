...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'app.locales.de.name' => 'string',
            'app.locales.de.flag' => 'string',
            'app.locales.de.locale' => 'string',
            'app.locales.en.name' => 'string',
            'app.locales.en.flag' => 'string',
            'app.locales.en.locale' => 'string',
            ...
            'database.warn-threshold.slow-query' => 'string',
            'database.warn-threshold.slow-queries' => 'string',
            ...
            'logging.channels.slow-queries.driver' => 'string',
            'logging.channels.slow-queries.path' => 'string',
            'logging.channels.slow-queries.level' => 'string',
            'logging.channels.sentry.driver' => 'string',
            'logging.channels.sentry_logs.driver' => 'string',
            'logging.channels.sentry_logs.level' => 'string',
            'logging.slow-queries-channel' => 'string',
            'mail.default' => 'string',
            ...
            'services.twitch.redirect' => 'string',
...
'app.aliases.View','app.aliases.Vite','app.locales.de.name','app.locales.de.flag','app.locales.de.locale',
'app.locales.en.name','app.locales.en.flag','app.locales.en.locale','auth.defaults.guard','auth.defaults.passwords',
...
'database.warn-threshold.slow-query','database.warn-threshold.slow-queries','debugbar.enabled','debugbar.hide_empty_tabs','debugbar.except',
...
'logging.channels.null.handler','logging.channels.emergency.path','logging.channels.slow-queries.driver','logging.channels.slow-queries.path','logging.channels.slow-queries.level',
'logging.channels.sentry.driver','logging.channels.sentry_logs.driver','logging.channels.sentry_logs.level','logging.slow-queries-channel','mail.default',
...
'sentry.tracing.default_integrations','services.postmark.key','services.resend.key','services.ses.key','services.ses.secret',
'services.ses.region','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.twitch.client_id','services.twitch.client_secret',
'services.twitch.redirect','session.driver','session.lifetime','session.expire_on_close','session.encrypt',
...
'session.same_site','session.partitioned','cookieconsent.url.domain','cookieconsent.url.middleware','cookieconsent.url.prefix',
'cookieconsent.cookie.name','cookieconsent.cookie.duration','cookieconsent.cookie.domain','cookieconsent.policy','cookieconsent.google_analytics.id',
'cookieconsent.google_analytics.anonymize_ip','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'debugbar.queries.explain','login','login.store','logout','verification.notice',
...
'two-factor.qr-code','two-factor.secret-key','two-factor.recovery-codes','two-factor.regenerate-recovery-codes','cookieconsent.script',
'cookieconsent.accept.all','cookieconsent.accept.essentials','cookieconsent.accept.configuration','cookieconsent.reset',
'home','dashboard','submitclip.create','submitclip.store','team',
'about','auth.twitch','auth.callback','locales','profile.edit','profile.update','profile.destroy','user-password.edit',
'user-password.update','appearance.edit','two-factor.show','storage.local',);
        registerArgumentsSet('views', 
'app','cookie-consent::button','cookie-consent::cookies','cookie-consent::info','laravel-exceptions-renderer::components.badge',
...
'validation.custom.attribute-name.rule-name','about.page_title','about.breadcrumb','about.hero.subtitle','about.hero.description',
'cookies.appearance.description','cookies.sidebar_state.description','login.title','login.description','login.connect_button',
'login.connect_button_aria','login.terms_notice','login.community_support','login.logo_alt','login.privacy',
'login.imprint','login.terms','login.all_rights_reserved','login.footer_navigation','login.github_aria',
'login.discord_aria','sendinclip.page_title','sendinclip.breadcrumb','sendinclip.headline','sendinclip.preview.title',
'sendinclip.preview.placeholder','sendinclip.preview.loading','sendinclip.submit.title','sendinclip.submit.clip_url_label','sendinclip.submit.clip_url_placeholder',
'sendinclip.submit.tags_label','sendinclip.submit.anonymous','sendinclip.submit.anonymous_hint','sendinclip.submit.cta','sendinclip.rules.title',
'sendinclip.rules.items.registered','sendinclip.rules.items.consent','sendinclip.rules.items.no_explicit','sendinclip.rules.items.tags_match','sendinclip.tips.title',
'sendinclip.tips.items.short','sendinclip.tips.items.quality','sendinclip.tips.items.funny','sendinclip.recent.title','sendinclip.recent.no_title',
'sendinclip.recent.open_clip','sendinclip.recent.views','sendinclip.recent.empty_title','sendinclip.recent.empty_subtitle','sendinclip.status.approved',
'sendinclip.status.rejected','sendinclip.status.pending','sendinclip.errors.login_required','sendinclip.errors.clip_url_required','sendinclip.errors.cannot_submit',
'sendinclip.errors.daily_limit','sendinclip.errors.generic','sendinclip.login.title','sendinclip.login.subtitle','sendinclip.login.alert',
'sendinclip.login.cta','team.page_title','team.breadcrumb','team.our_team','team.team_subtitle',
'team.total_members','team.member','team.members','team.avatar_alt','team.team_member',
'team.no_team_data','team.no_team_description','team.team_footer','team.roles.Admin','team.roles.Mod',
'team.roles.Jr Mod','team.roles.Cutter','team.roles.Community Manager','team.roles.IT-Management','team.roles.Dev/Tec',
'login.twitter_aria','cookieConsent::cookies.title','cookieConsent::cookies.intro','cookieConsent::cookies.link','cookieConsent::cookies.essentials',
'cookieConsent::cookies.all','cookieConsent::cookies.customize','cookieConsent::cookies.manage','cookieConsent::cookies.details.more','cookieConsent::cookies.details.less',
'cookieConsent::cookies.save','cookieConsent::cookies.cookie','cookieConsent::cookies.purpose','cookieConsent::cookies.duration','cookieConsent::cookies.year',
'cookieConsent::cookies.day','cookieConsent::cookies.hour','cookieConsent::cookies.minute','cookieConsent::cookies.categories.essentials.title','cookieConsent::cookies.categories.essentials.description',
'cookieConsent::cookies.categories.analytics.title','cookieConsent::cookies.categories.analytics.description','cookieConsent::cookies.categories.optional.title','cookieConsent::cookies.categories.optional.description','cookieConsent::cookies.defaults.consent',
'cookieConsent::cookies.defaults.session','cookieConsent::cookies.defaults.csrf','cookieConsent::cookies.defaults._ga','cookieConsent::cookies.defaults._ga_ID','cookieConsent::cookies.defaults._gid',
'cookieConsent::cookies.defaults._gat',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER','PHP_CLI_SERVER_WORKERS',
'BCRYPT_ROUNDS','LOG_CHANNEL','LOG_SLOW_QUERIES_CHANNEL','LOG_STACK','LOG_DEPRECATIONS_CHANNEL',
...
'DB_SLOW_QUERY_THRESHOLD','DB_SLOW_QUERIES_THRESHOLD','TWITCH_CLIENT_ID','TWITCH_CLIENT_SECRET','TWITCH_REDIRECT_URI',
'DEBUGBAR_OPEN_STORAGE','OCTANE_SERVER','SENTRY_LARAVEL_DSN','SENTRY_TRACES_SAMPLE_RATE',);
